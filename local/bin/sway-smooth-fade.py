...
# Smooth fading in sway-wm
#
# From https://www.reddit.com/r/swaywm/comments/e6ihm8/smooth_fading_in_sway/
...
AC_TRANS   = 0.95     # opacity of active window
INAC_TRANS = 0.82     # opacity of inactive windows
FLOAT_INAC = 0.82     # opacity of inactive floating windows
FADE_TIME  = 0.20     # time taken for fade to complete
